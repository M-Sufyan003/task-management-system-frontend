...
const AdminTaskAssignModal = ({ isOpen, onClose, onCreated }) => {
  ...
  return createPortal(
    <div
      ...
      onClick={(e) =>
        e.target.classList.contains(styles.overlay) && handleClose()
      }
    >
      <div
      ...
      >
        ...
        <div className={styles.notice}>
          ...
          Tasks created here are added to the system under the current admin
          account. Use the <strong>All Tasks</strong> page to reassign or edit
          status per user.
        </div>
        ...
        <form className={styles.form} onSubmit={handleSubmit} noValidate>
          ...
          <div className={styles.field}>
            <label className={styles.label}>
              ...
              />
              Reference User{" "}
              <span className={styles.optional}>(for tracking)</span>
            </label>
            {loading ? (
